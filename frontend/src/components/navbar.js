...
//     // Check if resource combination exists
//     const resourceExists = resources.some(
//       resource => resource.resourceNo === resourceNo && resource.resourceType === resourceType
//     );

//     if (resourceExists) {
//       triggerAlert('This resource combination already exists.');
//     } else {
//       createResource({ resourceNo, resourceType })
//         .then(data => {
//           console.log('Successful resource creation', data);
//           // Optionally, refetch resources to update the list
//           fetchData();
//           handleResourceClose();
//         })
//         .catch(err => {
